...
/**
 * {@code @ExcelImport} / {@code @ExcelExport} 的 Spring MVC（Servlet 栈）集成。
 * <p>
 * 只在 Servlet 型 Web 应用里生效；WebFlux 应用走
 * {@link ExcelWebFluxAutoConfiguration}，非 Web 应用两个都不生效。
 *
 * @author zengJiaJun
 * @since 2026年09月04日
 * @version 1.0
 */
@AutoConfiguration(after = {WebMvcAutoConfiguration.class, ExcelWebAutoConfiguration.class})
...
public class ExcelWebMvcAutoConfiguration {
    ...
    public ExcelImportArgumentResolver excelImportArgumentResolver(
        ...
        return new ExcelImportArgumentResolver(specFactory, properties, reactiveSupport);
    }
    ...
    public ExcelExportReturnValueHandler excelExportReturnValueHandler(
        ...
        return new ExcelExportReturnValueHandler(specFactory, reactiveSupport);
    }
     ...
     * WebFlux 那边不需要这么做，靠 {@code Ordered} 就能抢先。
     * <p>
