...
public class SecurityUser implements UserDetails, TenantDetail, CredentialsContainer {
     ...
     */
    public SecurityUser(String id, String username, String password, Set<GrantedAuthority> roles) {
        this(id, username, password, null, null, null, true, true, true, true, roles, null, null);
     ...
     */
    @JsonCreator
    public SecurityUser(@JsonProperty("id") String id, @JsonProperty("username") String username, @JsonProperty("password") String password,
...
//    }
    ...
    public static final class UserBuilder {
         ...
         * additional attributes for this user)
         */
        public UserBuilder roles(Collection<GrantedAuthority> roles) {
            return authorities(roles);
        }

        public UserBuilder roles(GrantedAuthority... roles) {
         ...
         * additional attributes for this user)
         */
        public UserBuilder authorities(Collection<GrantedAuthority> roles) {
        ...
        public UserBuilder id(String id) {
            Assert.notNull(roles, "id cannot be null");
            this.id = id;
            return this;
        }
        ...
        public UserBuilder expire(LocalDateTime expire) {
            this.expire = expire;
            return this;
        }

        public UserBuilder currentRole(GrantedAuthority currentRole) {
            this.currentRole = currentRole;
            return this;
        }

        public UserBuilder database(String database) {
            this.database = database;
            return this;
        }

        public UserBuilder schema(String schema) {
            this.schema = schema;
            return this;
        }
        ...
        public SecurityUser build() {
            ...
            return new SecurityUser(this.id, this.username, encodedPassword, tenant, database, schema, !this.disabled, !this.accountExpired,
