...
include("backend:components:tenant-component:core-tenant-component")
include("backend:components:tenant-component:row-tenant-component")
include("backend:components:tenant-component:table-tenant-component")
include("backend:components:tenant-component:schema-tenant-component")
include("backend:components:tenant-component:database-tenant-component")
include("backend:components:tenant-component:hybrid-tenant-component")
include("backend:components:tenant-component:h2-tenant-component")
include("backend:components:tenant-component:pg-tenant-component")
include("backend:components:tenant-component:liquibase-tenant-component")
